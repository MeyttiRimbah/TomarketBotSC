...
class Tomartod:
    ...
    def play_game_func(self, amount_pass):
        ...
        for i in range(amount_pass):
            ...
            star =  res.json().get("data", {}).get("stars", 0)
            data_claim = json.dumps(
                {"game_id": "59bcd12e-04e2-404c-a172-311a0084587d", "points": point, "stars": star}
            )
            ...
            self.log(f"{hijau}success {biru}claim{hijau} game point and star : {putih}{point} & {putih}{star}")
...
EEEEEEEEEEEEEEEEEEEEEEXXXXXXX       XXXXXXXYYYYYYY       YYYYYYY
E::::::::::::::::::::EX:::::X       X:::::XY:::::Y       Y:::::Y
E::::::::::::::::::::EX:::::X       X:::::XY:::::Y       Y:::::Y
EE::::::EEEEEEEEE::::EX::::::X     X::::::XY::::::Y     Y::::::Y
  E:::::E       EEEEEEXXX:::::X   X:::::XXXYYY:::::Y   Y:::::YYY
  E:::::E                X:::::X X:::::X      Y:::::Y Y:::::Y   
  E::::::EEEEEEEEEE       X:::::X:::::X        Y:::::Y:::::Y    
  E:::::::::::::::E        X:::::::::X          Y:::::::::Y     
  E:::::::::::::::E        X:::::::::X           Y:::::::Y      
  E::::::EEEEEEEEEE       X:::::X:::::X           Y:::::Y       
  E:::::E                X:::::X X:::::X          Y:::::Y       
  E:::::E       EEEEEEXXX:::::X   X:::::XXX       Y:::::Y       
EE::::::EEEEEEEE:::::EX::::::X     X::::::X       Y:::::Y       
E::::::::::::::::::::EX:::::X       X:::::X    YYYY:::::YYYY    
E::::::::::::::::::::EX:::::X       X:::::X    Y:::::::::::Y    
EEEEEEEEEEEEEEEEEEEEEEXXXXXXX       XXXXXXX    YYYYYYYYYYYYY    
        ...
        print(merah + f" FREE TO USEs")
        print(merah + f" contact telegram '{hijau}@ExynosAdmin{hijau}' if trouble use the bot")
        print()
